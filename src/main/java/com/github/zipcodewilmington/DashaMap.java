...
public class DashaMap implements HashMapX{
    ...
    public void set(String key, String value) {
        hashArray[Integer.parseInt(Objects.requireNonNull(HashFunctionOne(key)))].addNode(new Node<>(key,value,null));
    }

    @Override
    public String delete(String key) {
        SinglyLinkedList sll = hashArray[Integer.parseInt(Objects.requireNonNull(HashFunctionOne(key)))];
    ...
    public String get(String key) {
        return hashArray[Integer.parseInt(Objects.requireNonNull(HashFunctionOne(key)))].getNode(new Node<String>(key,null)).getKey();
    }
