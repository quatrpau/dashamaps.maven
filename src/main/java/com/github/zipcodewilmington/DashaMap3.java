...
public class DashaMap3 implements HashMapX{
    ...
    public void set(String key, String value) {
        hashArray[Integer.parseInt(Objects.requireNonNull(HashFunctionThree(key)))].addNode(new Node<>(key,value,null));
    }

    @Override
    public String delete(String key) {
        SinglyLinkedList sll = hashArray[Integer.parseInt(Objects.requireNonNull(HashFunctionThree(key)))];
    ...
    public String get(String key) {
        return hashArray[Integer.parseInt(Objects.requireNonNull(HashFunctionThree(key)))].getNode(new Node<String>(key,null)).getKey();
    }
    ...
    private String HashFunctionThree(String input) {
        if (input.length() > 1) {
            return (String.valueOf(input.charAt(0)+input.charAt(1))).toLowerCase(Locale.ROOT);
        }
        return null;
    }
}
